...
const Edit = ({ article, articlesCategories, articlesTags }) => {
    ...
    const handleSubmit = (e) => {
        ...
        post(route("admin.articles.update", article.id), formData, { forceFormData: true });
    };
        ...
        <AuthenticatedLayout>
            <div className="max-w-4xl mx-auto my-6">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    {/* Image Upload */}
                    <Label htmlFor="file_input">Upload New Image (optional)</Label>
                    <input
                        type="file"
                        id="file_input"
